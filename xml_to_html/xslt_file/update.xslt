...
//end of css,js pages 
	...
	<xsl:template match="field">
		...
		<xsl:choose>
			...
			<xsl:when test="(meta = 'mandatory')">
				<div class="form-group">
					<xsl:if test="(datatype != 'select')">
						<label for="{$name}"><xsl:value-of select="name"/>*:</label>
						<div class="form-group">
							<input type="{$datatype}" name="{$name}" required="true" class="form-control up-class" placeholder="Required" pattern="{$pattern}" title="{$message}"/>
						</div>
					</xsl:if>
			...
			<xsl:when test="(meta = 'optional')">
				<div class="form-group">
					<xsl:if test="(datatype != 'select')">
						<label for="{$name}"><xsl:value-of select="name"/>:</label>
						<div class="form-group">
							<input type="{$datatype}" name="{$name}" required="true" class="form-control up-class" placeholder="Optional" pattern="{$pattern}" title="{$message}"/>
						</div>
					</xsl:if>
			...
			<!-- <xsl:otherwise>
				...
				<xsl:if test="meta = 'optional'">
					<label for="{$name}"><xsl:value-of select="name"/>:</label>
					<div class="form-group">
					<input type="{$datatype}" name="{$name}" class="form-control up-class" placeholder="Optional" pattern="{$pattern}" title="{$message}"/>
					</div>
				</xsl:if>
